...
_defineProperty(_default, "targets", ['clickBtn', 'resetBtn']);
...
/* harmony import */ var _plugins_init_sortable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/init_sortable */ "./src/plugins/init_sortable.js");
...
var application = stimulus__WEBPACK_IMPORTED_MODULE_2__["Application"].start();

var context = __webpack_require__("./src/controllers sync recursive \\.js$");

application.load(Object(stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_3__["definitionsFromContext"])(context)); // Element selections

var search = document.querySelector("#submit"); // Function calls

Object(_movies__WEBPACK_IMPORTED_MODULE_0__["fetchMovies"])("matrix");
Object(_plugins_init_sortable__WEBPACK_IMPORTED_MODULE_1__["default"])(); // Event listeners

search.addEventListener("click", _movies__WEBPACK_IMPORTED_MODULE_0__["searchMovies"]); // //////////////////////
// Rehearsal
// //////////////////////
// // 1. Select the button
...
var displayMovies = function displayMovies(movies) {
  movies.forEach(function (movie) {
    results.insertAdjacentHTML("beforeend", "<li class='list-inline-item'>\n        <img width=\"120\" src=\"".concat(movie.Poster, "\" alt=\"poster\" />\n      </li>"));
  });
};

var fetchMovies = function fetchMovies(keyword) {
...
var searchMovies = function searchMovies(event) {
...
var initSortable = function initSortable() {
  var moviesUl = document.querySelector("#results");
  sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(moviesUl, {
    ghostClass: "ghost",
    animation: 1500,
    onEnd: function onEnd(event) {
      alert("".concat(event.oldIndex, " moved to ").concat(event.newIndex));
    }
  });
};

/* harmony default export */ __webpack_exports__["default"] = (initSortable);
